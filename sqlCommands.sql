...
(507, 'sruti', 6370126201),
(510, 'harish', 2045613378),
(511, 'sana', 78945661200);
...
INSERT INTO `orders` (`order_id`, `order_date`, `qty`, `price`, `product_id`, `customer_id`) VALUES
(1, '2021-01-27', 15, 40, 1, 501),
(2, '2021-01-22', 10, 32, 2, 502),
(3, '2021-01-27', 20, 42, 3, 503),
(4, '2021-01-21', 27, 21, 4, 504),
(5, '2021-02-03', 10, 45, 1, 504),
(6, '2021-03-10', 7, 35, 2, 507),
(7, '2021-02-09', 12, 45, 3, 502),
(8, '2021-02-17', 10, 22, 4, 502),
(9, '2021-03-10', 20, 45, 1, 502),
(10, '2021-04-14', 15, 33, 5, 502),
(11, '2021-05-12', 6, 22, 4, 507),
(12, '2021-06-16', 10, 43, 3, 507),
(13, '2021-07-15', 15, 45, 1, 505),
(14, '2021-08-18', 7, 31, 2, 507),
(15, '2021-07-14', 10, 41, 3, 505),
(16, '2021-07-28', 4, 25, 4, 505),
(407, '2021-08-09', 10, 44, 1, 507);
...
--
ALTER TABLE `customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=512;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=408;
...
--
ALTER TABLE `supplier`
  MODIFY `supplier_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
