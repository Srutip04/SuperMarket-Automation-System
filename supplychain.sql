...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2021 at 12:51 AM
...
INSERT INTO `orders` (`order_id`, `order_date`, `Product_id`, `customer_id`, `comp_id`) VALUES
(401, '2021-09-27', 1, 501, 202),
(402, '2021-09-22', 2, 502, 201),
(403, '2021-09-27', 3, 503, 206),
(404, '2021-09-21', 4, 504, 204),
(405, '2021-09-24', 5, 505, 204),
(406, '2021-09-23', 6, 506, 203);
...
INSERT INTO `products` (`Product_id`, `Product_name`, `Unit`, `price`, `mfg_date`, `comp_id`) VALUES
(1, 'Cupcakes', '100 - 100 g pieces', 43.9, '2021-09-01', 201),
(2, 'Northwoods Cranberry Sauce', '12 - 12 oz jars', 40, '2021-09-01', 201),
(3, 'Pencils', '5000', 10, '2021-09-09', 206),
(4, 'Chips', '6000', 30, '2021-09-08', 205),
(5, 'Grandma\'s Boysenberry Spread', '12 - 8 oz jars', 25, '2021-09-16', 203),
(6, 'Coffee', '16 - 500 g tins', 46, '2021-09-24', 204);
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`comp_id`) REFERENCES `company` (`comp_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `products`
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`comp_id`) REFERENCES `company` (`comp_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
